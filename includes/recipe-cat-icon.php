...
function recipe_category_icon_add() {
	...
	<div class="form-field">
		...
		<ul class="recipe-cat-icon" name="" id="category_icon"> 
			'.recipe_icons_list( '' ).'
			<input type="hidden" name="term_meta[category_icon]" value="">
		</ul>
	...
	<table class="form-table">
		<tbody>
			<tr class="form-field form-required">
				...
				<td>
					<ul class="recipe-cat-icon" name="term_meta[category_icon]" id="category_icon"> 
						<?php echo recipe_icons_list( $value ); ?>
						<input type="hidden" name="term_meta[category_icon]" value="<?php echo esc_attr( $value ); ?>">
					</ul>
					<p class="description"><?php _e( 'Select icon for the code category', 'recipe' ); ?></p>
				</td>
			</tr>
		</tbody>
	</table>
